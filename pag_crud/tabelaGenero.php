        ...
        <div class="main">
            ...
            <div class="">
              ...
              <?php
                ...
                <h1>Gêneros</h1>
                <a href="formGenero.php"><button class="btn adicionar">Adicionar</button></a>
                </div>
                <?php
                  ...
                  <tbody>
                    <?php
                      foreach($generos as $genero){
                        ...
                        echo "
                        <form id='form_atualizar' method ='get' action='./atualizar/receberValoresGen.php'>
            ...
            echo "<h1>Gêneros</h1>
            <a href='formGenero.php'><button class='btn botao_vazio'>Adicionar</button></a>";
            echo"</div>";
