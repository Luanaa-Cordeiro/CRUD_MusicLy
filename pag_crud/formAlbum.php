...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <div id="formulario">
            <form  method ="POST" class=" was-validated form_php space-y-4 md:space-y-6" action="./cadastros/cadastAlbum.php" data-parsley-validate>
          ...
          ?>
          <span id="titulo_form">Adicione uma Álbum!</span>
