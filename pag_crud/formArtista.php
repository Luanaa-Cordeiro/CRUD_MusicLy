...
<head>
    ...
    <title>Adicionar Artistas</title>
...
<div class="wrapper">
        ...
        <div class="main">
            ...
            <form  method ="POST" class="form_php space-y-4 md:space-y-6" action="./cadastros/cadastArtista.php" data-parsley-validate>
            ...
            <div class="card-body">
                <div class="row">
                  <div class=" mb-4">
                    ...
                    <label class="form-label" for="nome_artista">Nome do Artista<span class="asterisco">*</span></label>
                    <div id="input_art">
                      <input placeholder="Nome" name="nome" type="text" id="nome_artista" class="form-control" required/>
                      </div>
                    </div>
                  </div>
