...
<hr>
    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <form method ="POST" class=" was-validated form_php space-y-4 md:space-y-6" action="genero.php" data-parsley-validate>
                <div class="main">
                    <div class="formulario shadow">

                    <div class="header-text mb-1 ">
                        <h2>Modifique o Gênero!</h2>
                    </div>

                    <div id ="input_usuario" class=" d-flex flex-column">
                    <input type="hidden" id="id" name="id" value="<?php echo $id_genero; ?>"/>
                    <input type="text" class="form-control form-control-lg bg-light fs-6"id="nome" name="nome" value="<?php echo $nome_genero; ?>"/><br>
                    </div>
