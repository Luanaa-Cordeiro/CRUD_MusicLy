          ...
          <div id="inputs_alb" class="card-body">
                <div class="row">
                  <div class="col-md-6 mb-4">
                    ...
                    <label class="form-label" for="name">Nome do álbum</label>
                      <input placeholder="Nome" name="nome" type="text" id="name" class="form-control" value="<?php echo $nome_album;?>" required/>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div data-mdb-input-init class="form-outline">
                    <label class="form-label" for="data">Data de Lançamento</label>
                        ...
                        <?php
                                ...
                                if (count($artistas) > 0) {
                                    foreach ($artistas as $artista) {
                                        if($artista['id_artista'] == $artista_nome){
                                            $selected = 'selected';
                                        } else{
                                            $selected = '';
                                        }
