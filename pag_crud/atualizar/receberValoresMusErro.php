...
if (isset($_GET["id"]) && isset($_GET["nome"]) && isset($_GET["data"]) && isset($_GET["artista"]) &&  isset($_GET["album"]) && isset($_GET["genero"]) ) {
    $id_musica = $_GET["id"];
                        ...
                        <?php
                                ...
                                if (count($generos) > 0) {
                                    foreach ($generos as  $genero) {
                                        if($genero['id_genero'] == $genero_nome){
                                            $selected = 'selected';
                                        } else{
                                            $selected = '';
                                        }
