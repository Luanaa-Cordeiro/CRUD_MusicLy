    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ['Artista', 'Quantidade'],
                <?php
                    $sql = "SELECT ar.nome AS Artista, COUNT(m.id_musica) AS contIDcat
                            FROM musicas AS m
                    ...
                    foreach($relatorios as $relatorio){
                        echo "['" . $relatorio['Artista'] . "', " . $relatorio['contIDcat'] . "],";
                    }
                ?>
        ]);
...
<div class="wrapper">
        ...
        <div class="main">
            ...
            <h1>Artistas com mais músicas!</h1>
                <div class="shadow grafico_pizza">
                    <div id="piechart"></div>
                </div>
                <div id="voltar">
                <a href="relatorioArtista.php"><button>Voltar</button></a>
                </div>
            </div>
    <?php
        } else{
